...
function App() {
  ...
  const updateBookingStatus = async (docId, newStatus, reason = '', updatedBy = 'system', approverRole = null, additionalData = null) => {
    try {
      console.log('Updating booking status:', { docId, newStatus, reason, updatedBy, approverRole, additionalData });
      ...
      const updatedBooking = await updateBookingStatusInDb(
        ...
        updatedBy,
        approverRole,
        additionalData  // Pass the additionalData parameter to the service function
      );
